...
_filter_halftoning_sfc_ui::_filter_halftoning_sfc_ui(_gl_widget *GL_widget1, string Name1)
{
  Name=Name1;
...
_filter_halftoning_sfc_ui::_filter_halftoning_sfc_ui(_gl_widget *GL_widget1, std::map<string, string> &Parameters, string Name1)
{
...
_qtw_filter_halftoning_sfc::_qtw_filter_halftoning_sfc(_gl_widget *GL_widget1,_filter_halftoning_sfc_ui *Filter1,string Box_name)
{
  QString Str;
