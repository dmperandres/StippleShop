...
_filter_gaussian_ui::_filter_gaussian_ui(_gl_widget *GL_widget1,string Name1)
{
  Name=Name1;
...
_filter_gaussian_ui::_filter_gaussian_ui(_gl_widget *GL_widget1, std::map<string, string> &Parameters, string Name1)
{
...
_qtw_filter_gaussian::_qtw_filter_gaussian(_gl_widget *GL_widget1,_filter_gaussian_ui *Filter1,string Box_name)
{
  QString Str;
