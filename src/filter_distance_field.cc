...
void _filter_distance_field::jump_flooding(cv::Mat *Input_image,cv::Mat *Output_image)
{
  ...
  vector<_f_distance_field_ns::_point> *Read,*Write;
...
_filter_distance_field_ui::_filter_distance_field_ui(_gl_widget *GL_widget1,string Name1)
{
  Name=Name1;
...
_filter_distance_field_ui::_filter_distance_field_ui(_gl_widget *GL_widget1, std::map<std::string,std::string> &Parameters, string Name1)
{
...
void _filter_distance_field_ui::write_parameters(std::map<std::string,std::string> &Parameters)
{
  ...
  Parameters["line_width"]=string(Aux);
}
...
_qtw_filter_distance_field::_qtw_filter_distance_field(_gl_widget *GL_widget1,_filter_distance_field_ui *Filter1,string Box_name)
{
  QString Str;
