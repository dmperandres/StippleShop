...
void _filter_dot_ebg::set_dots_images(std::vector<std::vector<cv::Mat *> > *Dots1)
{
  Dots=Dots1;
}
...
_filter_dot_ebg_ui::_filter_dot_ebg_ui(_gl_widget *GL_widget1, std::string Name1)
{
  Name=Name1;
...
_filter_dot_ebg_ui::_filter_dot_ebg_ui(_gl_widget *GL_widget1, std::map<std::string, std::string> &Parameters, std::string Box_name)
{
...
void _filter_dot_ebg_ui::write_parameters(std::map<std::string,std::string> &Parameters)
{
  ...
  Parameters["pixel_density"]=std::string(Aux);
  ...
  Parameters["black_dots"]=std::string(Aux);
...
_qtw_filter_dot_ebg::_qtw_filter_dot_ebg(_gl_widget *GL_widget1,_filter_dot_ebg_ui *Filter1,std::string Box_name)
{
  QString Str;
