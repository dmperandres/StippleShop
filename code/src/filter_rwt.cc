...
_filter_rwt_ui::_filter_rwt_ui(_gl_widget *GL_widget1,std::string Name1)
{
  Name=Name1;
...
_filter_rwt_ui::_filter_rwt_ui(_gl_widget *GL_widget1,std::map<std::string,std::string> &Parameters,std::string Box_name)
{
...
void _filter_rwt_ui::write_parameters(std::map<std::string, std::string> &Parameters)
{
  Q_UNUSED(Parameters)
}
...
_qtw_filter_rwt::_qtw_filter_rwt(_gl_widget *GL_widget1,_filter_rwt_ui *Filter1,std::string Box_name)
{
  QString Str;
