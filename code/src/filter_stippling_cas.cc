...
_filter_stippling_cas_ui::_filter_stippling_cas_ui(_gl_widget *GL_widget1,std::string Name1)
{
  Name=Name1;
...
_filter_stippling_cas_ui::_filter_stippling_cas_ui(_gl_widget *GL_widget1, std::map<std::string, std::string> &Parameters, std::string Box_name)
{
...
void _filter_stippling_cas_ui::write_parameters(std::map<std::string,std::string> &Parameters)
{
  ...
  Parameters["exponent"]=std::string(Aux);
  sprintf(Aux,"%d",parameter3());
  Parameters["g+"]=std::string(Aux);
  sprintf(Aux,"%d",parameter4());
  Parameters["g-"]=std::string(Aux);
  sprintf(Aux,"%5.2f",parameter5());
  Parameters["k"]=std::string(Aux);
}
...
_qtw_filter_stippling_cas::_qtw_filter_stippling_cas(_gl_widget *GL_widget1,_filter_stippling_cas_ui *Filter1,std::string Box_name)
{
  QString Str;
  char Aux[100];
